    ...
    <div class="row" style="margin-top: 60px" align="center">
        ...
        <form method="post" action="/controller" name="add_product_form">
            ...
            <div class="mb-3 w-25" style="margin-top: 40px">
                ...
                <input type="number" class="form-control" id="price" value="${add_product_form_data_map.price}" name="price" required="required"/>
            </div>
            <div class="mb-3 w-25" style="margin-top: 40px">
            ...
            <div class="mb-3  w-25">
                ...
                <input class="form-control" type="file" id="image" value="${add_product_form_data_map.image}" name="image">
            </div>
            <div class="mb-3 w-25" style="margin-top: 40px">
                <label for="comment" class="form-label" ><fmt:message key="main_client.prod_comment"/></label>
                <textarea class="form-control" id="comment" value="${add_product_form_data_map.comment}" name="comment" rows="3" required="required"></textarea>
            </div>
